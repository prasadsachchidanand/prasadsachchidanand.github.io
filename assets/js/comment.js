...
function createFormattingToolbar() {
  ...
  const buttons = [
    { label: "B", format: "**", title: "Bold" },
    { label: "I", format: "*", title: "Italic" },
    { label: "~~", format: "~~", title: "Strikethrough" },
    { label: "H1", format: "# ", title: "Heading 1", block: true },
    { label: "H2", format: "## ", title: "Heading 2", block: true },
    { label: "Link", format: "[text](url)", title: "Link", isLink: true },
    { label: "Code", format: "`", title: "Inline Code" },
    { label: "```", format: "```\n\n```", title: "Code Block", block: true, multiline: true },
    { label: "Math", format: "$", title: "Inline Math" },
    { label: "List", format: "- ", title: "Bullet List", block: true, list: true }
  ];
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Override the renderContent function to handle mentions
  ...
  window.renderContent = function(text) {
    ...
    processedText = processedText.replace(mentionRegex, '<span class="user-mention">@$1</span>');
    
    // Process the markdown
    const renderedContent = marked.parse(processedText);
